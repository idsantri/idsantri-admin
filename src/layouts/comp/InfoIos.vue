<template lang="">
	<q-card style="min-width: 300px">
		<q-card-section class="q-py-sm q-px-md bg-green-6 text-green-11 text-subtitle1">
			Instal Aplikasi
		</q-card-section>
		<q-card-section class="q-py-sm q-px-md">
			<p class="no-margin">Instal aplikasi untuk mendapatkan pengalaman lebih baik!</p>
			<q-separator class="q-my-sm" />
			<p class="no-margin">Bagi Pengguna iOS!</p>
			<ol class="no-margin q-pl-md">
				<li>
					Pastikan Anda menggunakan browser
					<span class="text-weight-bold">Safari</span>;
				</li>
				<li>Ketuk ikon &ldquo;bagikan&rdquo; (sebuah kotak dengan panah ke atas di bagian bawah layar);</li>
		...
		<q-card-actions align="right" class="bg-green-5 q-py-sm q-px-md">
