<template lang="">
	<CardPage>
		<CardHeader title="Statistik Izin Pesantren" :show-reload="false"> </CardHeader>
...
async function getList() {
	try {
		...
		const data = await IzinPesantren.listThAjaran();
...
async function getData(thAjaranH) {
	...
	try {
		...
		const data = await Statistik.izinPesantren(thAjaranH);
