<template>
	<q-card style="width: 100%" flat>
		<q-card-section class="bg-green-7 text-green-1 q-pa-sm flex items-center">
			<h2 class="text-subtitle1 no-margin text-green-11">Cari Orang Tua</h2>
			<q-space />
			<q-btn
				label="Tambah"
				color="green-12"
		...
		<q-card-section>
			<data-table class="display table nowrap dt" :options="options" style="overflow: hidden" />
		</q-card-section>
		<q-card-actions class="bg-green-6">
			<div class="text-body2 text-green-11 text-italic">
				<div>▪️ Cari berdsarkan ID, nama ayah/ibu, atau NIK</div>
