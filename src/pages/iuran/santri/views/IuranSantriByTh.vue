<template>
	<div class="relative-position">
		<div v-if="iuran.length > 0">
			<div class="q-pa-sm bg-green-11" style="overflow-x: auto">
			...
			<div style="overflow-x: auto">
				<q-list separator style="min-width: 500px">
					<template v-for="(item, index) in iuran" :key="index">
						<q-item
							class="q-px-sm"
							clickable=""
								...
								<div class="flex items-center q-gutter-x-sm">
									<div class="q-card--bordered rounded-borders q-px-sm">
										<q-toggle
											...
											:false-value="false"
											@update:model-value="
												(value, event) => toggleLunas(value, event, item, index)
											"
										/>
									</div>
									<div class="q-card--bordered rounded-borders q-px-sm">
						...
						<div v-if="item.show" class="tw:text-xs tw:p-2 tw:bg-green-200/50">
							<div>
								<em>Lunas:</em>&nbsp;
								{{
									item.lunas
			...
			<div class="q-pa-sm bg-green-8 flex items-center justify-between">
				<div class="text-green-11 text-overline">
					TOTAL CETAK
