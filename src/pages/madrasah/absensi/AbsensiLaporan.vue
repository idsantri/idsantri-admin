		...
		<q-card class="q-mt-sm" flat bordered>
			...
			<q-card-section class="no-padding">
				<q-markup-table flat>
					...
					<tbody v-if="!params.th_ajaran_h || !params.tingkat_id || !params.list_bulan_ujian">
						<tr>
							<td colspan="50">
			...
			<q-card-section class="bg-green-6 text-green-11 text-subtitle1 q-pa-sm full-width flex flex-center">
