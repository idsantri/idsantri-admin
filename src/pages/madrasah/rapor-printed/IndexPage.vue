				...
				<template v-slot:top>
					<div class="text-green-10">
						...
						<div class="text-caption text-italic" style="line-height: 1rem">
							Hapus data berikut agar DATA RAPOR (Nilai Mapel, Nilai Ahwal, dan Absensi) tidak terkunci!
						</div>
				...
				<template v-slot:body="props">
					<q-tr :props="props">
						...
						<q-td class="text-center">
							<q-btn icon="sym_o_delete" color="negative" dense flat @click="deleteRow(props.row.id)" />
						</q-td>
					</q-tr>
				</template>
			</q-table>
